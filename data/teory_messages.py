THEORY_MSGS = {
    ...
    "сортировка выбором": "Алгоритм сортировки выбором (или selection sort) — один из простейших"
                          ...
                          "1. Инициализация: Начнем с первого элемента массива.\n"
                          "2. Поиск минимального элемента: Найдем минимальный элемент в"
                          " оставшейся неотсортированной части массива.\n"
                          "3. Обмен местами: Поменяем местами найденный минимальный элемент"
                          " с первым элементом неотсортированной части.\n"
                          "4. Повторение процесса: Перейдем к следующему элементу массива и повторим шаги"
                          " 2 и 3, пока весь массив не будет отсортирован.\n\n"
                          "```python\n"
