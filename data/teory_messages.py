THEORY_MSGS = {
    ...
    "алгоритм Дейкстры": "Алгоритм Дейкстры используется для нахождения кратчайшего пути во взвешанном графе"
    ...
    "жадные алгоритмы": "Жадные алгоритмы (или алгоритмы жадного выбора) решают задачи,"
                        " делая на каждом шаге наиболее оптимальный выбор с точки зрения текущего состояния."
                        " Они часто используются, когда необходимо добиться оптимального или приемлемого"
                        " решения за разумное время. Такой подход иногда не гарантирует нахождение глобального"
                        " оптимума, но часто может предложить хорошее приближение.\n\n"
                        "Рассмотрим задачу про радиостанции:\n"
                        "1. Постановка задачи: Имеется множество штатов, которые должны быть покрыты радиостанциями."
                        " Каждая станция покрывает определенные штаты\n."
                        "2. Жадный подход: На каждом шаге выбираем станцию, которая"
                        " покрывает наибольшее количество еще не покрытых штатов.\n"
                        "3. Реализация:\n"
                        "```python\n"
                        "states_needded = set(['mt', 'wa', 'or', 'id', 'nv', 'ut', 'ca', 'az'])\n\n"
                        "stations = {}\n"
                        ...
                        "final_stations = set()\n\n"
                        "while states_needded:\n    "
                        "best_station = None\n    "
                        "states_covered = set()\n    "
                        "for station, states_for_station in stations.items():\n        "
                        "covered = states_needded & states_for_station\n        "
                        "if len(covered) > len(states_covered):\n            "
                        "best_station = station\n            "
                        "states_covered = covered\n    "
                        "final_stations.add(best_station)\n    "
                        "states_needded -= states_covered\n\n"
                        "print(final_stations)```\n\n"
                        "4. Процесс:\n"
                        "- Определяем, какие штаты еще не покрыты.\n"
                        "- Для каждой станции вычисляем количество покрываемых ею штатов, которые еще не закрыты.\n"
                        "- Выбираем станцию, которая покрывает наибольшее количество таких штатов.\n"
                        "- Добавляем выбранную станцию в итоговый список.\n"
                        "- Удаляем покрытые станции из множества еще непокрытых.\n\n"
                        "5. Результат: Получаем набор станций, который минимально покрывает все необходимые штаты.\n\n"
                        "Жадные алгоритмы эффективны по времени, но не всегда дают оптимальное решение во всех задачах."
                        " Однако, в задачах подобного типа, они могут значительно снизить вычислительные затраты.",
}
